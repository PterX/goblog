...
type HtmlPushLog struct {
	...
	CreatedTime int64  `json:"created_time" gorm:"column:created_time;type:bigint(20);autoCreateTime;index"`
	ModTime     int64  `json:"mod_time" gorm:"column:mod_time;type:bigint(20)"`

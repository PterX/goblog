...
type UserWithdraw struct {
	...
	SuccessTime int64  `json:"success_time" gorm:"column:success_time;type:bigint(20);default:0"`          // 成功时间
	...
	ErrorTimes  int    `json:"error_times" gorm:"column:error_times;type:bigint(20) not null;default:0"`   // 执行错误次数
